...
import in.com.testbook.chatapp.Utils.GetTimeAgo;
import in.com.testbook.chatapp.Adapters.MessageAdapter;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.with(ChatActivity.this).load(imgURL).placeholder(R.drawable.default_avatar).into(mProfileImage);
