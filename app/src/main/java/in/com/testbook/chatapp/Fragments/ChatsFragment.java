package in.com.testbook.chatapp.Fragments;
...
import in.com.testbook.chatapp.Activities.ChatActivity;
import in.com.testbook.chatapp.Models.Conversation;
...
public class ChatsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        initControls(mMainView);
        return mMainView;
    }

    private void initControls(View mMainView) {
    ...
    public static class ConversationViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setMessage(String message, boolean isSeen){
            ...
            if(message.contains("https://firebasestorage.googleapis.com/v0/b/testfirebase1-48b83.appspot.com/")){
                userStatusView.setText("Image Message");
            }else{
